...
* [Flagger](https://github.com/fluxcd/flagger) para lançamentos poderosos nativos do Kubernetes, incluindo abordagens de implantação blue/green, canaryo e testes A/B.
...
* Para soluções de baixo código, você pode seguir o guia de [entrega contínua para Soluções de Low-Code/No-Code](low-code-solutions/low-code-solutions.md).
